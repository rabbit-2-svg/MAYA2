...
ud_post_loop_string = ["wb_avail_buf_restore_loop_check_no_enough"]

def _get_basic_perf_bm_filename():
  return os.path.join(test_conf["chip_prod"], test_conf["chip_capacity"], test_conf["device_type"], "performance_without_restore.yaml")

#fio 4g_restore
# FIO SR
@pass_fail_common_deco()
def FIO_4G_Restore_No_enough_SR_3times():
  ...
  benchmark_item = get_benchmark_item(_get_basic_perf_bm_filename(), ["FIO", "FIO_4G_Restore_No_enough"])
...
# FIO RandRead
@pass_fail_common_deco()
def FIO_4G_Restore_No_enough_RR_3times():
  # pre_case, post_case, pre_loop and post_loop definition
  tc_logger.info("Defining pre_case, post_case, pre_loop and post_loop inside of test case")
...
# FIO RandWrite
@pass_fail_common_deco()
def FIO_4G_Restore_No_enough_RW_3times():
  # pre_case, post_case, pre_loop and post_loop definition
  tc_logger.info("Defining pre_case, post_case, pre_loop and post_loop inside of test case")
...
def IOzone_Seq_4G_Restore_No_enough_3times():
  ...
  ud_pre_loop_string.extend(["file_for_assistant_test:rw=write@bs=512k@size=4g@runtime=600@fio_fg=True","wb_avail_buf_restore_loop_check_no_enough"])
  ...
  # performance result verification
  benchmark_item = get_benchmark_item(_get_basic_perf_bm_filename(), ["IOZone", "IOzone_Seq_4G_Restore_No_enough"])
  tc_logger.info("Benchmark is as below")
  tc_logger.info(str(benchmark_item))
...
# IOzone_Random_4G
@pass_fail_common_deco()
def IOzone_Rand_4G_Restore_No_enough_3times():
  # pre_case, post_case, pre_loop and post_loop definition
  tc_logger.info("Defining pre_case, post_case, pre_loop and post_loop inside of test case")
  ...
  # performance result verification
  benchmark_item = get_benchmark_item(_get_basic_perf_bm_filename(), ["IOZone", "IOzone_Rand_4G_Restore_No_enough"])
  tc_logger.info("Benchmark is as below")
  tc_logger.info(str(benchmark_item))
  result_file = os.path.join(test_conf["result_home"], "iozone_result.csv")
  result = 0
